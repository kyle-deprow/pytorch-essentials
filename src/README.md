...
The Python scripts in this directory are originally generated from the top-notch learning module [05. Going Modular Part 2 (script mode)](https://github.com/mrdbourke/pytorch-deep-learning/blob/main/going_modular/05_pytorch_going_modular_script_mode.ipynb) and then modified as I found extra functionalities.
